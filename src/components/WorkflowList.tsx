          ...
          >
            <div className="workflow-main">
              <div className="workflow-status">
                <span className="status-icon" style={{ color: getStatusColor(workflow.status) }}>
                  {getStatusIcon(workflow.status)}
                </span>
                <span className="workflow-id">{workflow.id}</span>
              </div>

              <div className="workflow-time">{formatTime(workflow.startTime)}</div>
            </div>
            ...
            <div className="workflow-step">{workflow.currentStep}</div>
