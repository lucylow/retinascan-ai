                ...
                <form onSubmit={(e) => {
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div>
                      ...
                      <input
                        ...
                        onBlur={handleBlur}
                        className={`w-full px-4 py-3 rounded-lg bg-gray-700 border text-white placeholder-gray-400 focus:outline-none focus:ring-2 transition-all ${
                  ...
                  <div className="mb-6">
                    ...
                    <textarea
                      ...
                      onBlur={handleBlur}
                      rows={5}
                      className={`w-full px-4 py-3 rounded-lg bg-gray-700 border text-white placeholder-gray-400 focus:outline-none focus:ring-2 transition-all resize-none ${
