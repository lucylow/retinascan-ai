...
const features: Feature[] = [
  ...
  },
  {
    id: '6',
    title: '24/7 Support',
    description: 'Round-the-clock customer support and documentation.',
    icon: '💬',
        ...
        <AnimatedSection>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Everything you need to build amazing websites and applications
            </p>
          </div>
        </AnimatedSection>
            ...
            <AnimatedSection key={feature.id} delay={index * 100}>
              ...
              >
                <div className="p-8 h-full flex flex-col">
                  <div
                    className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${feature.color} flex items-center justify-center text-2xl mb-6 transition-transform duration-300 ${
