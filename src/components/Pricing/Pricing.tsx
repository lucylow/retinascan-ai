...
export const Pricing: React.FC = () => {
  ...
  const [_selectedPlan, setSelectedPlan] = useState<string>('professional');
          ...
          <div className="text-center mb-16">
            ...
            <div className="flex items-center justify-center gap-4 mb-12">
              ...
              <button
                ...
                className="relative w-14 h-7 bg-blue-600 rounded-full transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500"
              >
                <div
                  className={`absolute top-1 w-5 h-5 bg-white rounded-full transition-transform duration-300 ${
                    billingPeriod === 'year' ? 'transform translate-x-7' : 'transform translate-x-1'
                  }`}
                />
              </button>
